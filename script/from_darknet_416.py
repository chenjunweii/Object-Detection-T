...
print('Data [:10] : ', data.flatten()[50000:50010])
...
for i in range(3):
    ...
    print('Output [:10] : ', m.get_output(0).asnumpy().flatten()[:10])
    print('Output [:10] : ', m.get_output(0).asnumpy().dtype)
